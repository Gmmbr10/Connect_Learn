...
<body>
	...
	<main class="container justify-center">
		...
		<section class="flex-center grid-flex">
			
			<form class="box" method="POST" id="sigin_form">
				...
				<section class="grid-flex">
					<section class="input-box">
						...
						<input class="input" type="text" name="nome" id="input_nome">
						<span class="error" id="error_nome"></span>
					</section>
					<section class="input-box">
						<label for="input_sobrenome">Sobrenome:</label>
						<input class="input" type="text" name="sobrenome" id="input_sobrenome">
				...
				<section class="input-box">
					<section class="grid-flex">
						<section class="input-box-checkbox">
							<input class="checkbox" type="radio" name="tipo_usuario" id="input_tipo_usuario_e" value="estudante">
							<label for="input_tipo_usuario_e">Estudante</label>
						</section>
						<section class="input-box-checkbox">
							<input class="checkbox" type="radio" name="tipo_usuario" id="input_tipo_usuario_p" value="professor">
				...
				<section class="input-box">
					...
					<input class="input" type="tel" name="telefone" id="input_telefone">
				...
				<section class="input-box">
					...
					<input class="input" type="password" name="confirmar_senha" id="input_confirmar_senha">
