...
$navbar = file_get_contents("src/view/admin_templates/navbar.html");
$html = file_get_contents("src/view/admin_templates/comunidades.html");

$header = file_get_contents("src/view/admin_templates/header.html");
