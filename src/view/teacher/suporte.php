...
<body>
  ...
  <dialog id="modal_suporte">
    ...
    <header>
      ...
      <i class="fa-solid fa-close" onclick="window.location.href = '<?=INCLUDE_PATH?>teacher/suporte'"></i>
    ...
    <span class="btn" onclick="window.location.href = '<?=INCLUDE_PATH?>teacger/suporte'">Fechar</span>
