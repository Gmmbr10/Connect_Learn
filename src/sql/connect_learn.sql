...
create table modulos (
  ...
  primary key(mod_id),
  foreign key(mod_id_curso) references cursos(cur_id)
);
...
create table aulas (
  ...
  primary key(aul_id),
  foreign key(aul_id_modulo) references modulos(mod_id)
);
...
create table duvidas (
  ...
  primary key(duv_id),
  foreign key(duv_id_usuario) references usuarios(usu_id)
);
...
create table respostas (
  ...
  primary key(res_id),
  foreign key(res_id_duvida) references duvidas(duv_id),
  foreign key(res_id_usuario) references usuarios(usu_id)
);
...
create table desafios (
  ...
  primary key(des_id),
  foreign key(des_id_usuario) references usuarios(usu_id)
);
...
create table grupos (
  ...
  primary key(gru_id),
  foreign key(gru_id_fundador) references usuarios(usu_id),
  foreign key(gru_id_desafio) references desafios(des_id)
);
...
create table usuarios_grupos (
  ...
  foreign key(usu_gru_id_grupo) references grupos(gru_id),
  foreign key(usu_gru_id_usuario) references usuarios(usu_id)
);
...
create table comunidades (
  ...
  primary key(com_id),
  foreign key(com_id_fundador) references usuarios(usu_id)
);
